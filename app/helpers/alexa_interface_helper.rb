module AlexaInterfaceHelper
  ...
  def make_alexa_location_api_call(device_id, consent_token)
    HTTParty.get("https://api.amazonalexa.com/v1/devices/#{device_id}/settings/address/countryAndPostalCode", headers: {"User-Agent" => "Httparty", "Authorization" => "Bearer Atc|#{consent_token}"})
  end
