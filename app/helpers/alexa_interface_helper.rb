module AlexaInterfaceHelper
  ...
  def get_device_id
    ...
    params['context']['System']['device']['deviceId'][(17..-1)]
  end
  ...
  def make_alexa_location_api_call(device_id, consent_token)
    HTTParty.get("https://api.amazonalexa.com/v1/devices/#{device_id}/settings/address/countryAndPostalCode", headers: {"User-Agent" => "Httparty","Content-Type" => "application/json", "Authorization" => "Bearer Atc|#{consent_token}"}, format: :json)
  end
